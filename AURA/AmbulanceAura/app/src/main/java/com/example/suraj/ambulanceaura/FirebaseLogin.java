...
public class FirebaseLogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (auth.getCurrentUser() != null) {
            startActivity(new Intent(FirebaseLogin.this, Main2Activity.class));
            finish();
        }
        ...
        btnReset.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(FirebaseLogin.this, ResetPasswordActivity.class));
            }
        });
                        ...
                        .addOnCompleteListener(FirebaseLogin.this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (!task.isSuccessful()) {
                                    ...
                                    Intent intent = new Intent(FirebaseLogin.this, Main2Activity.class);
