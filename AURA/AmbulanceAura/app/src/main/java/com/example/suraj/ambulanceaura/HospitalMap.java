...
public class HospitalMap extends FragmentActivity implements GeoQueryEventListener, GoogleMap.OnCameraChangeListener {

    private static final GeoLocation INITIAL_CENTER = new GeoLocation(12.3007176, 76.6350077);
    private static final int INITIAL_ZOOM_LEVEL = 14;
    private static final String GEO_FIRE_DB = "https://auraambulance.firebaseio.com/";
    private static final String GEO_FIRE_REF = GEO_FIRE_DB + "path/to/geofire";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseApp app = FirebaseApp.initializeApp(this, options,"geofire");
